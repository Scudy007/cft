...
*(Опционально)* Если в проекте настроен сид данных (seed), выполните его для заполнения БД тестовыми пользователями и уязвимостями.
...
*(Примечание: Замените данные выше на ваши реальные тестовые аккаунты перед отправкой репозитория).*
...
*(Добавьте скриншоты в папку public/screenshots и раскомментируйте строки выше)*
</details>
